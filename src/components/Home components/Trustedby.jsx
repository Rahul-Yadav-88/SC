  ...
  return (
    <section className="px-4 py-16 bg-gray-50">
      <div className="max-w-6xl mx-auto text-center">
        <h2 className="text-4xl md:text-5xl font-bold text-[#262626]">
          Trusted by
        </h2>
        ...
        <div className="relative mt-14">
          ...
          >
            <div className="flex items-center gap-12 px-2 min-w-max animate-scrollx group-hover:[animation-play-state:paused]">
